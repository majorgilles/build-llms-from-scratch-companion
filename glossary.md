...
| Model response | `model_response` | Continuation generated by the fine-tuned model for one held-out instruction |
| Judge model | `judge_model` | External model asked to score generated responses against references |
